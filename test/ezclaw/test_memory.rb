...
class TestMemory < Minitest::Test
  ...
  def test_read_from_data_dir_if_exists
    ...
    mem = Ezclaw::Memory.new(config_dir: @config_dir, data_dir: @data_dir, filename: "memory.md")
  ...
  def test_read_returns_empty_string_if_no_file
    mem = Ezclaw::Memory.new(config_dir: @config_dir, data_dir: @data_dir, filename: "nonexistent.md")
